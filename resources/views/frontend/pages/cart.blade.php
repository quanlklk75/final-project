    ...
    <section id="cart_items">
        <div class="container">
                ...
                <table class="table table-condensed">
                    ...
                    @foreach($cartContent as $item)
                        ...
                        <td class="cart_delete">
                            <a id_pro ="{{ $item->id }}" class="cart_quantity_delete btn_df btn_table_td_rf_del" href=""><i class="fa fa-times" style="color: red"></i></a>
                        </td>
                    </tr>
                    @endforeach
                    <tr>
            ...
            <div class="shopper-informations" style="margin-bottom: 70px">
                <div class="row">
                    <div class="col-sm-8">
                    <a class="btn btn-primary" href="{{ route('checkout') }}">Continue</a>
                    </div>
                </div>
            </div>
        </div>
